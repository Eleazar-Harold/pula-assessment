      ...
      <div class="col-md-5 p-3 login justify-content-md-center">
        ...
        <form v-on:submit.prevent="signup">
          <div class="form-group">
            <input type="text" name="username" id="username" v-model="username" class="form-control" placeholder="Username">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <input type="password" name="password2" id="pass2" v-model="password2" class="form-control" placeholder="Confirm Password">
          </div>
